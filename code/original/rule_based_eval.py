...
# 输入文件所在目录
input_path = '/ihome/hdaqing/jul230/program/result/test/'
files = [f'extracted_{entity}.csv']

# 输出文件保存路径
output_file_path =f'/ihome/hdaqing/jul230/program/result/tools/rule_annotations_extracted_{entity}.csv'
